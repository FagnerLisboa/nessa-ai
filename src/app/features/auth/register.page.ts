  ...
  template: `
    <section class="auth-container">
      <div class="auth-card">
        ...
        <p class="auth-subtitle">Preencha seus dados para começar a usar a NESSA AI</p>
        ...
        <div class="auth-footer">
          Já tem uma conta? <a routerLink="/login" class="link">Fazer login</a>
        </div>
      </div>
    </section>
  `,
  ...
  async onSubmit() {
    ...
    try {
      ...
      if (error?.status === 400) {
        ...
        this.errorMessage.set("Ocorreu um erro durante o cadastro. Tente novamente.");
      }
    } finally {
